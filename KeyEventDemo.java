		...
		ActionListener
{
	...
	private static final String FILE_HEADER = "UserName,H.period,DD.period.t,UD.period.t,H.t,DD.t.i,UD.t.i,H.i,DD.i.e,UD.i.e," +
...
//			displayArea.setText("Please use shift key instead of capslock");
//		}
		...
		if(e.getKeyCode() == KeyEvent.VK_ENTER){
			...
			if( str.equals(".tie5Roanl")){
				...
				pressIndex = 0;
				typingArea.setText("");
				generateCsv(keyStoreParams,"Deepti");
				generateCsvInNano(keyStoreParamsInNano,"Deepti");
				return;
